...
export class Render {
    ...
    public async loadAssets() {
        this.assets = [
            { path: '../assets/inv/potion.png', src: await loadImage('../assets/inv/potion.png'), type: RenderType.Potion },
            { path: '../assets/inv/disk_lvl1.png', src: await loadImage('../assets/inv/disk_lvl1.png'), type: RenderType.Weapon },
            { path: '../assets/inv/armor_lvl1.png', src: await loadImage('../assets/inv/armor_lvl1.png'), type: RenderType.Armory },
    ...
    public renderInfo(playerData: { hp: number, armory: number, power: number, inventory: Array<IItem> }) {
